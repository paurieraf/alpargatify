...
HDD_PATH="/Volumes/WD Elements AE/FLAC"
LOSSLESS_ORGANIZED="$HOME/alpargatamusic/lossless-organized"
LOSSY_PATH="/Volumes/WD Elements AE/lossy"
BEETS_CONFIG="$HOME/workspace/repos/alpargatify/library-organizer/beets/beets-config.yaml"
PARALLEL_WRAPPER="$HOME/workspace/repos/alpargatify/library-organizer/parallel-wrapper.sh"
